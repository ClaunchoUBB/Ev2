...
public class VentaTest {
    ...
    @Test
    public void rechazarVentaPorStockInsuficienteTest() {
        Mueble mueble = MuebleTest.buildMueble();
        mueble.setPrecioBase(10000);
        mueble.setStock(5);
        Mueble muebleGuardado = servicioMueble.saveMueble(mueble);
        ...
        assertNull(venta, "La venta NO debe crearse porque no hay stock suficiente");

        Mueble muebleSinCambios = servicioMueble.getMueble(muebleGuardado.getIdMueble());
        assertEquals(5, muebleSinCambios.getStock(), "El stock no debe modificarse");
    }
